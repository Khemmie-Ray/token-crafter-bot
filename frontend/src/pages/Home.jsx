          ...
          <div className="flex flex-col lg:flex-row md:flex-row justify-between">
            <div className="lg:w-[32%] md:w-[32%] w-[100%] mb-4">
              ...
              <p className="text-[#6E6C6C]">
                Start by connecting your X account, then explore the
                subscription options to gain full access to the platform.
              </p>
            </div>
            <div className="lg:w-[32%] md:w-[32%] w-[100%] mb-4">
              <h2 className="lg:text-[100px] md:text-[80px] text-[50px] text-center font-black text-skyblue">
            ...
            <div className="lg:w-[32%] md:w-[32%] w-[100%] mb-4">
              ...
              <p className="text-[#6E6C6C]">
                Now, you’re ready to deploy your token! Use either the Twitter
                bot or the platform bot to easily launch your token on Starknet.
              </p>
            </div>
          </div>
        </div>
